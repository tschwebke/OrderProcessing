                ...
                if (wi.LastChangedAgeInMinutes(1))
                {
                    ...
                    else
                    {
                        ...
                        try
                        {
                            ...
                            //message.ToRecipients.Add("chads@microsoft.com"); //TODO: Testing
                            //message.ToRecipients.Add("cspgoc@microsoft.com");
                            //message.ToRecipients.Add("v-gerals@microsoft.com"); //TODO: Testing
                            //message.ToRecipients.Add("v-minadl@microsoft.com"); //TODO: Testing
                            //message.CcRecipients.Add("v-josmel@microsoft.com");
                            message.CcRecipients.Add("Svcasfp@microsoft.com"); //TODO: Testing
                            //message.CcRecipients.Add("v-minadl@microsoft.com");
