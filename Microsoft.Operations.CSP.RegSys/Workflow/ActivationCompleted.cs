...
namespace Microsoft.Operations.CSP.RegSys
{
    public partial class Service1
    {
        ...
        public void ActivationCompleted_DoWork(object sender, DoWorkEventArgs e)
        {
            ...
            {
                wiql = string.Format(@"SELECT [System.Id], [System.WorkItemType], [System.Title], [System.AssignedTo], [System.State], [System.Tags] FROM WorkItems WHERE [System.TeamProject] = 'CSP' AND [System.WorkItemType] = 'SKU Purchase' AND [System.State] = 'Validated' AND [Microsoft.VSTS.Common.SubState] = 'Active' AND [Microsoft.Operations.EmailControl.InvitationReminder]='Automatic' AND [Microsoft.Operations.Partners.Nomination.OriginalSource]<>'ASfP RegSys Form' ORDER BY [System.Id]");
            }
            ...
            foreach (WorkItem wi in workitems)
            {
                if (wi.LastChangedAgeInMinutes(1))
                {
                    ...
                    switch (wi.GetFieldValue("Microsoft.Operations.Partners.Partner.CurrentState"))
                    {
                        ...
                        // "") { errors.Add("Missing SAM Alias"); } if
                        // (wi.GetFieldValue("Microsoft.Operations.Partners.Support.SAM.Alias") !=
                        // "") { if
                        // (!wi.GetFieldValue("Microsoft.Operations.Partners.Support.SAM.Alias").IsValidEmailAddress())
                        // { errors.Add("SAM Email is malformed"); } else { act.SAMEmail =
                        // wi.GetFieldValue("Microsoft.Operations.Partners.Support.SAM.Alias"); } }
                        // if (wi.GetFieldValue("Microsoft.Operations.Partners.Support.SAM.DisplayName")
                        // == "") { errors.Add("Missing SAM Name"); } else { act.SAM =
                        // wi.GetFieldValue("Microsoft.Operations.Partners.Support.SAM.DisplayName");
                        // } if (wi.GetFieldValue("Microsoft.Operations.Partners.Service.BillAmount")
                        // == "") { errors.Add("Missing PA Custom Bill Amount"); } else {
                        // act.CustomBillAmount =
                        // wi.GetFieldValue("Microsoft.Operations.Partners.Service.BillAmount"); } if (wi.GetFieldValue("Microsoft.Operations.CreditDiscountApproval.Request.SKUs")
                        // == "") { errors.Add("No SKUs were listed"); } else { act.SKUs =
                        // wi.GetFieldValue("Microsoft.Operations.CreditDiscountApproval.Request.SKUs");
                        // } break;
                    ...
                    else
                    {
                        ...
                        try
                        {
                            ...
                            switch (activationType)
                            {
                                ...
                                // case 1: content.AppendLine("
                                // <p>" + Resources.Activate_PAIntro_2 + "</p>
                                // ", order_lineitems[0].TrimStart()); break;

                                // case 2: content.AppendLine("
                                // <p>" + Resources.Activate_PAIntro_3 + "</p>
                                // ", order_lineitems[0].TrimStart(), order_lineitems[1]); break;

                                // case 3: content.AppendLine("
                                // <p>" + Resources.Activate_PAIntro_4 + "</p>
                                // ", order_lineitems[0].TrimStart(), order_lineitems[1],
                                // order_lineitems[2]); break;

                                // case 4: content.AppendLine("
                                // <p>" + Resources.Activate_PAIntro_5 + "</p>
                                // ", order_lineitems[0], order_lineitems[1], order_lineitems[2],
                                // order_lineitems[3]); break;

                                // default: content.AppendLine("
                                // <p>" + Resources.Activate_PAIntro_1 + "</p>
                                // "); break; }
                                ...
                                // content.AppendLine("
                                // <li style="font-size: 10.5pt; font-family: \&quot;Segoe UI\&quot;,sans-serif; color: #333333">
                                // " + Resources.Activate_SendVAT + "
                                // </li>
                                // ", bizDays.ToString("D", CultureInfo.CreateSpecificCulture(displayLang)));

                                // content.AppendLine("
                                // <li style="font-size: 10.5pt; font-family: \&quot;Segoe UI\&quot;,sans-serif; color: #333333">
                                // " + Resources.Activate_SendBillContact + "
                                // </li>
                                // ");
                            ...
                            message.CcRecipients.Add("svcasfp@microsoft.com");
